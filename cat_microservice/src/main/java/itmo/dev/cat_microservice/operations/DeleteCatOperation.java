...
public class DeleteCatOperation implements Operation{

    private final RabbitTemplate rabbitTemplate;
    private final CatService catService;

    public DeleteCatOperation(RabbitTemplate rabbitTemplate, CatService catService) {
    ...
    public void execute(Message message, String nameQueue) {
        ...
        catService.deleteCat(ownerId, id);
        rabbitTemplate.convertAndSend(nameQueue, "Cat deleted");
    }
}
